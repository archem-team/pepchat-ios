    ...
    NSFWOverlayViewDelegate, UIGestureRecognizerDelegate
{
    ...
    private lazy var messageInputHandler = MessageInputHandler(
    ...
    private func scrollToReferenceMessageWithRetry(
...
class NSFWOverlayView: UIView {
    ...
    static func show(in parentView: UIView, channelName: String, delegate: NSFWOverlayViewDelegate?)
        -> NSFWOverlayView
    {
